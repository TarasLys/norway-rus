...
function startQuiz() {
  ...
  startContainer.style.display = "none"; // Скрыть контейнер с кнопкой "Начать викторину"
  ...
  function askQuestion() {
    ...
    document.getElementById("submitAnswer").onclick = function() {
      ...
      if (currentRound < rounds) {
        ...
        startContainer.style.display = "flex"; // Показать контейнер с кнопкой "Начать викторину" после окончания игры
      }
    };
  }
